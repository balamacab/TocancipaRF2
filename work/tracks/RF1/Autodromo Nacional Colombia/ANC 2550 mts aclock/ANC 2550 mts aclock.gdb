ANC 2550 mts aclock
{
  ...
  EventName = 2.550 mts Anticlockwise // shows up in rFactor as the subfolder.
  GrandPrixName = 2.550 mts Anticlockwise //this must be the same as event name in order to sort circuit info correctly.
  VenueName = Autodromo Nacional Colombia // shows up in rFactor as the main folder.
  Location = Colombia
  Length = 2.550 mts (2.5 Km)
  TrackType = Permanent Road Course
  Track Record = NN, 0.000
  TerrainDataFile = ANC 2550 mts aclock.tdf
  ...
  SettingsCopy = ANC 2550 mts aclock.svm
  SettingsAI = ANC 2550 mts aclock.svm

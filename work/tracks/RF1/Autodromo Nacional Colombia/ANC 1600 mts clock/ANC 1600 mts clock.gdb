ANC 1600 mts clock
{
  ...
  EventName = 1.600 mts Clockwise // shows up in rFactor as the subfolder.
  GrandPrixName = 1.600 mts Clockwise //this must be the same as event name in order to sort circuit info correctly.
  VenueName = Autodromo Nacional Colombia // shows up in rFactor as the main folder.
  Location = Colombia
  Length = 1.600 mts (1.6 Km)
  TrackType = Permanent Road Course
  Track Record = NN, 0.000
  TerrainDataFile = ANC 1600 mts clock.tdf
  ...
  DayAmbientRGB = (57,83,100)
  DayDirectionalRGB = (200,207,211)
  ...
  SettingsCopy = ANC 1600 mts clock.svm
  SettingsAI = ANC 1600 mts clock.svm

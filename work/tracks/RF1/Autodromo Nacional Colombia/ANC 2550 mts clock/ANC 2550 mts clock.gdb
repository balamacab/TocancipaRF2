ANC 2550 mts clock
{
  ...
  EventName = 2.550 mts Clockwise // shows up in rFactor as the subfolder.
  GrandPrixName = ANC 2.550 mts Clokwise //this must be the same as event name in order to sort circuit info correctly.
  ...
  TerrainDataFile = ANC 2550 mts clock.tdf
  ...
  SettingsCopy = ANC 2550 mts clock.svm
  SettingsAI = ANC 2550 mts clock.svm

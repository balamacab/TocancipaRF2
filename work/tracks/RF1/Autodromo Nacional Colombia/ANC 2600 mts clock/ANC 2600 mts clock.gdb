ANC 2600 mts clock
{
  Filter Properties = Autodromo Nacional Colombia 
  Attrition = 30
  TrackName = Autodromo Nacional Colombia
  EventName = 2.600 mts Clockwise // shows up in rFactor as the subfolder.
  GrandPrixName = 2.600 mts Clockwise //this must be the same as event name in order to sort circuit info correctly.
  VenueName = Autodromo Nacional Colombia // shows up in rFactor as the main folder.
  Location = Colombia
  Length = 2.600 mts (2.6 Km)
  TrackType = Permanent Road Course
  Track Record = NN, 0.000
  TerrainDataFile = ANC 2600 mts clock.tdf
  ...
  DayAmbientRGB = (97,99,104)
  DayDirectionalRGB = (217,220,222)
  DayFogRGB = (214,217,225)
  ...
  SettingsFolder = Autodromo Nacional Colombia
  SettingsCopy = Grip.svm
  SettingsCopy = ANC 2600 mts clock.svm
  SettingsAI = ANC 2600 mts clock.svm

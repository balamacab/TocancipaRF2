ANC 2010 mts clock
{
  ...
  EventName = 2.010 mts Clockwise // shows up in rFactor as the subfolder.
  GrandPrixName = 2.010 mts Clockwise //this must be the same as event name in order to sort circuit info correctly.
  ...
  TerrainDataFile = ANC 2010 mts clock.tdf
  ...
  SettingsCopy = ANC 2010 mts clock.svm
  SettingsAI = ANC 2010 mts clock.svm

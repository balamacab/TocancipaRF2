ANC 2010 mts aclock
{
  ...
  EventName = 2.010 mts AntiClockwise // shows up in rFactor as the subfolder.
  GrandPrixName = 2.010 mts AntiClockwise //this must be the same as event name in order to sort circuit info correctly.
  VenueName = Autodromo Nacional Colombia // shows up in rFactor as the main folder.
  Location = Colombia
  Length = 2.010 mts (2.1 Km)
  TrackType = Permanent Road Course
  Track Record = NN, 0.000
  TerrainDataFile = ANC 2010 mts aclock.tdf
  ...
  SettingsCopy = ANC 2010 mts aclock.svm
  SettingsAI = ANC 2010 mts aclock.svm

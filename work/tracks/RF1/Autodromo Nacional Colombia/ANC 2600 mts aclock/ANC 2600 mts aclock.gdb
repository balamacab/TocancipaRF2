ANC 2600 mts aclock
{
  ...
  EventName = 2.600 mts AntiClockwise // shows up in rFactor as the subfolder.
  GrandPrixName = 2.600 mts AntiClockwise //this must be the same as event name in order to sort circuit info correctly.
